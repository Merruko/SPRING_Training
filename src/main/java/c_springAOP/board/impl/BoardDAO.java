package c_springAOP.board.impl;
...
import c_springAOP.board.BoardService;
import c_springAOP.board.BoardVO;
import c_springAOP.common.JDBCUtil;
...
public class BoardDAO implements BoardService{
	...
	// SQL 명령어들
	/* MySQL용 쿼리
	private final String BOARD_INSERT = "insert into r_board(seq, title, writer, content, regdate ) values ((select ifnull(max(seq)+1,1) from r_board b) , ?, ? ,? , NOW())";
	 */
	/* Oracle용 쿼리 */
	...
	public void insertBoard(BoardVO vo) {
		System.out.println("===> JDBC로 insertBoard() 기능 처리 : "+vo.getTitle()+" | "+vo.getWriter()+" | "+vo.getContent());
		try {
